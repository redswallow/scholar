...
<?php
	$uid=$_SESSION['uid'];
	$result=mysql_query("SELECT * FROM author where id in(select author_id from user_bookmark_author where user_id='$uid')");
...
?>
	<div class="paper" onmouseover="this.style.backgroundColor='#F7F3E8';" onmouseout="this.style.backgroundColor='#FFF';" style="background-color: rgb(255,255,255);" >
		...
		<span class="feedback">
			<a id="bookmark_paper" href="bookmark.php?type=delinlist&author_id=<?php echo $author_id;?>"><font color="red">[UnBookmark]</font></a>
